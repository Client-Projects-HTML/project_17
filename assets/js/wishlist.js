      ...
      container.innerHTML = favProducts.map(p => `
        <div class="product-card">
          <div class="product-img-wrapper">
            ...
            <button onclick="wishlistManager.toggleItem('${p.id}')" class="absolute top-3 right-3 w-9 h-9 bg-white/90 dark:bg-slate-900/90 rounded-full flex items-center justify-center shadow-md hover:scale-110 transition-transform">
